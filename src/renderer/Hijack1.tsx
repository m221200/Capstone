...
const Hijack1 = () => {
  ...
  function sendDroneMAC() {
    ...
    ipcRenderer.send('droneChannel', myContainer2.current.value);
    navigate('/hijack2')
  }
  ...
  // <div className="Hello">
  //   <input ref={myContainer2} onChange={success} type="text" id="DroneChannel" className="css-input" placeholder="Drone's Channel"></input>
  // </div>
  ...
  return (
    <div className="summary">
      ...
      <div>
          ...
          <h2 className="Hello">sudo airodump-ng wlp2s0mon</h2>
          ...
          <div className="Hello">
            <input ref={myContainer2} onChange={success2} type="text" id="DroneChannel" className="css-input" placeholder="Drone's Channel"></input>
          </div>
          ...
          <div className="Hello"><button ref={myButton} onMouseOver={fulltest} onClick={sendDroneMAC}>Next</button></div>
      </div>
