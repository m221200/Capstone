  ...
  return (
    <div className="summary">
      ...
      <div>
          ...
          <h2>When you are done playing with the drone, or have unfortunately sent it into emergency mode, type “process.exit()” and press continue to the summary page!</h2>
